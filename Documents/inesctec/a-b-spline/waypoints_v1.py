...
def generate_waypoints_file(gps_path: List[Tuple[float, float]], altitude: float = 10.0, filename: str = "mission.waypoints"):
...
def main():
    ...
    try:
        ...
        # Definimos o destino no código para já (exemplo)
        goal_lat, goal_lon = start_lat + meters_to_lat(8), start_lon + meters_to_lon(4, start_lat)
    except Exception:
    ...
    # Place obstacle exactly at the midpoint
    ...
    generate_waypoints_file(gps_path, altitude=10.0)
